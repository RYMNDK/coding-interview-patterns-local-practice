...
public class LinkedListsRunner {
    ...
    private static boolean testFlattenMultiLevelList() {
        ...
        MultiLevelListNode flattened = FlattenMultiLevelList.flattenMultiLevelList(node1);
    ...
    private static boolean testLinkedListIntersection() {
        ...
        ListNode intersection1 = LinkedListIntersection.linkedListIntersection(headA1, headB1);
    ...
    private static boolean testLinkedListReversal() {
        ...
        ListNode reversed = LinkedListReversal.linkedListReversal(headA);
    ...
    private static boolean testLinkedListReversalRecursive() {
        ...
        ListNode reversed = LinkedListReversalRecursive.linkedListReversalRecursive(headA);
    ...
    private static boolean testPalindromicLinkedList() {
        ...
        if (!(PalindromicLinkedList.palindromicLinkedList(headA) && PalindromicLinkedList.palindromicLinkedList(headB))) {
            return false;
        }
    ...
    private static boolean testRemoveKthLastNode() {
        ...
        headA = RemoveKthLastNode.removeKthLastNode(headA, k);
